...
# Parameters defined inside g(x)
# 27.806679 seconds (278.53 M allocations: 114.874 GiB, 35.16% gc time)  

# Parameters defined outside g(x)
# 15.191241 seconds (278.54 M allocations: 114.873 GiB, 11.85% gc time)

# fortran takes about 1.05 s to finish.
